...
public class ActivityFamiliar extends AppCompatActivity {
    ...
    private void configurarBroadcastReciever()
    {
        ...
        filterStepReceive = new IntentFilter("PASOS_ACTUALIZADOS");
        filterAlarmReceive = new IntentFilter(MqttHandlerService.ACTION_DATA_ALARM_RECEIVE);
        filterStateReceive = new IntentFilter(MqttHandlerService.ACTION_DATA_ON_OFF_RECEIVE);
