...
#define DISTANCE_THRESHOLD                  150 // Minimum distance to trigger alarm
...
transition state_table[MAX_EVENTS][MAX_STATES] =
{
  ...
  { turn_on  , none                       , none             , none             , alarm_collision_right_on    , alarm_collision_left_on     , alarm_collision_both_on    }, // EV_SWITCH_ON
  ...
  { none     , none                       , none             , none             , alarm_collision_right_on    , alarm_collision_left_on     , alarm_collision_both_on    }, // EV_CONT
  { none     , alarm_stick_off            , alarm_stick_off  , alarm_stick_off  , alarm_stick_off             , alarm_stick_off             , alarm_stick_off            }, // EV_PRESSED
...
void get_new_event()
{
  ...
  if( timeout )
  {
    ...
    if( (verify_button_on()==true) || ( verify_pressure_sensor() == true) 
